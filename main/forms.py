...
class NewNotesForm(forms.Form):
    ...
    text1=forms.CharField(widget=Textarea(attrs={"name":"text1"}))
    text2 = forms.CharField(widget=Textarea(attrs={"name": "text2"}))
    text3 = forms.CharField(widget=Textarea(attrs={"name": "text3"}))
    text4 = forms.CharField(widget=Textarea(attrs={"name": "text4"}))
    text5 = forms.CharField(widget=Textarea(attrs={"name": "text5"}))
    text6 = forms.CharField(widget=Textarea(attrs={"name": "text6"}))
    text7 = forms.CharField(widget=Textarea(attrs={"name": "text7"}))
